...
public class InheritanceTest {
    ...
    private static final Path SOURCE_FOLDER = Path.of("io", "dragee", "rules", "sample", "inheritance");
    private static final Path OUTPUT_FOLDER = Path.of("io", "dragee", "rules", "sample", "inheritance");
