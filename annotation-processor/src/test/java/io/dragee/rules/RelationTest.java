...
public class RelationTest {
    ...
    class Name {
        ...
        void name_of_dragee() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.name")
                    .isString()
                    .isEqualTo("io.dragee.rules.sample.DrageeOne");
        }
    }
    ...
    class FieldRelation {
        ...
        void direct_object() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.dragee.rules.sample.DrageeTwo']")
                    .isArray()
                    .contains("field");
        }
        ...
        void generic_type() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.dragee.rules.sample.DrageeFive']")
                    .isArray()
                    .contains("field");
        }
    }
    ...
    class ConstructorRelation {
        ...
        void generic_type() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.dragee.rules.sample.DrageeThree']")
                    .isArray()
                    .contains("constructor");
        }
    }
    ...
    class MethodParamRelation {
        ...
        void is_omitted_when_method_is_private() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.dragee.rules.sample.DrageeSeven']")
                    .isAbsent();
        }
    }
    ...
    class MethodReturnRelation {
        ...
        void direct_object() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.dragee.rules.sample.DrageeFour']")
                    .isArray()
        ...
        void is_omitted_when_method_is_private() {
            ...
            assertThatJson(actualContent)
                    .inPath("$.depends_on.['io.dragee.rules.sample.DrageeSix']")
                    .isAbsent();
        }
    }
    ...
    class NonDrageeTest {
        ...
        void only_dragee_are_kept() {
            ...
            assertThatJson(actualContent)
                    ...
                    .isObject()
                    .containsOnlyKeys(
                            "io.dragee.rules.sample.DrageeTwo",
                            "io.dragee.rules.sample.DrageeThree",
                            "io.dragee.rules.sample.DrageeFour",
                            "io.dragee.rules.sample.DrageeFive");
        }
    }
}
